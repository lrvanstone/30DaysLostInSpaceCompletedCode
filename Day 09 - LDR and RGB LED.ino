...
int sensorValue = 0; // variable that we'll use to sotre the value reading from the sensor

int red = 11;  // these are output pins for three LED colours
int green = 10;
int blue = 9;
...
// Now let's light the LED with the appropriate colour...
