...
void u8g_prepare(void) { // Housekeeping that needs to be done at the start of the program
...
// The rest of this code is copied from the website *****************
